...
const USE_SET_HIDE_TITLEBAR_KEY = 'use-set-hide-titlebar';
...
const MaximusPrefsWidget = new GObject.Class({
    ...
    _init: function (params) {
        ...
        // set_hide_titlebar?
        this.addBoolean(_("Use alternate method for hiding the titlebar?\nNOTE: more stable, but doesn't work with Ambiance and Radiance window themes (there may be others)."),
            USE_SET_HIDE_TITLEBAR_KEY);
